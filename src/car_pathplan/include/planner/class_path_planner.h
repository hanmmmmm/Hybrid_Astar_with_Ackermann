...
#include "autodrive_dev_msgsrv/car_states.h"
...
private:
    ...
    autodrive_dev_msgsrv::car_states car_state_;

    tf::StampedTransform robot_to_map_tf_;

    void map_callback(const nav_msgs::OccupancyGrid::ConstPtr &msg);
    void goal_callback(const geometry_msgs::PoseStamped::ConstPtr &msg);
    void state_callback(const autodrive_dev_msgsrv::car_states::ConstPtr &msg);
...
void ClassPathPlanner::state_callback(const autodrive_dev_msgsrv::car_states::ConstPtr &msg)
{
