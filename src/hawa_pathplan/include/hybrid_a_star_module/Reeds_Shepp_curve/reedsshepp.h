...
public:
    ...
    std::vector<ClassReedSheppPath::pathResult> results_;  // it might be better to use linked-list. 
...
void ReedsSheppClass::setup(  std::array<double, 3> start_pose, std::array<double, 3> goal_pose )
{
    ...
    // std::cout << "ReedsSheppClass start pose: " << start_pose[0] << " " << start_pose[1]  << " " << start_pose[2] << std::endl;  

    // std::cout << "ReedsSheppClass goal pose: " << goal_pose[0] << " " << goal_pose[1]  << " " << goal_pose[2] << std::endl;  
...
void ReedsSheppClass::LpSpLp( ){
    ...
    if( valid ){
        ...
        all_possible_paths_.LpSpLp.path_length_unitless = calc_weighted_length(std::vector<double>{t, u, v});
...
void ReedsSheppClass::LpSpRp( ){
    ...
    if( valid ){
        ...
        all_possible_paths_.LpSpRp.path_length_unitless = calc_weighted_length(std::vector<double>{t, u, v});
...
void ReedsSheppClass::LmSmRm( ){
    ...
    if( valid ){
        ...
        all_possible_paths_.LmSmRm.path_length_unitless = calc_weighted_length(std::vector<double>{-t, -u, -v});
...
void ReedsSheppClass::RpSpLp( ){
    ...
    if( valid ){
        ...
        all_possible_paths_.RpSpLp.path_length_unitless = calc_weighted_length(std::vector<double>{t, u, v});
...
void ReedsSheppClass::RmSmLm( ){
    ...
    if( valid ){
        ...
        all_possible_paths_.RmSmLm.path_length_unitless = calc_weighted_length(std::vector<double>{-t, -u, -v});
...
void ReedsSheppClass::LRL_base( ){
    ...
    all_possible_paths_.LpRpLp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LpRpLm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LpRmLp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LpRmLm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LmRpLp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LmRpLm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LmRmLp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.LmRmLm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
...
void ReedsSheppClass::RLR_base( ){
    ...
    all_possible_paths_.RpLpRp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RpLpRm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RpLmRp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RpLmRm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RmLpRp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RmLpRm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RmLmRp.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
    ...
    all_possible_paths_.RmLmRm.path_length_unitless = calc_weighted_length(std::vector<double>{new_t, new_u, new_v});
...
void ReedsSheppClass::get_samples_L( const double target_angle_change, double& robot_yaw, double& robotx, double& roboty, ClassReedSheppPath::pathResult& result_container )// const std::string path_type  )
{
    ...
    while ( std::abs( theta_change )  < std::abs( target_angle_change ) ){
        ...
        double _body_frame_dx = turning_raius_ * sin(ang_step_size_local);
        double _body_frame_dy = turning_raius_ - turning_raius_ * cos(ang_step_size_local);
    ...
    double _body_frame_dx = turning_raius_ * sin(target_angle_change);
    double _body_frame_dy = turning_raius_ - turning_raius_ * cos(target_angle_change);
...
void ReedsSheppClass::get_samples_S( const double target_angle_change, double  robot_yaw, double& robotx, double& roboty, ClassReedSheppPath::pathResult& result_container ) 
{
    ...
    double _target_distance = target_angle_change*turning_raius_;
    bool _finish = false;
...
{
    double _body_frame_dx = turning_raius_ * sin(angle_change);
    double _body_frame_dy = -turning_raius_ + turning_raius_ * cos(angle_change);
