#ifndef CLASS_ASTAR_PLANNER
#define CLASS_ASTAR_PLANNER
...
#include "../hybrid_a_star_module/class_astar.h"
...
void ClassPathPlanner::path_plan( const ros::TimerEvent &event )
{
    ...
    if(planner_setup_success)
    {
        ...
        if( found_path ){
            ...
            std::deque<array<double, 2>> path;
            planner_.get_path_in_meter(path);
